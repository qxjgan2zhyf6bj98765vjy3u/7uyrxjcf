...
UUID=${UUID:-'b58aa3d0-3c9a-4a2a-83ce-70499ba7e425'}
VMESS_WSPATH=${VMESS_WSPATH:-'/b58aa3d0-3c9a-4a2a-83ce-70499ba7e425-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/b58aa3d0-3c9a-4a2a-83ce-70499ba7e425-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/b58aa3d0-3c9a-4a2a-83ce-70499ba7e425-trojan'}
SS_WSPATH=${SS_WSPATH:-'/b58aa3d0-3c9a-4a2a-83ce-70499ba7e425-shadowsocks'}
